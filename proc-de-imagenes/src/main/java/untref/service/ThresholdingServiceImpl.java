...
public class ThresholdingServiceImpl implements ThresholdingService {
	...
	@Override
	public ThresholdingResult obtainThresholdByBasicGlobalMethod(Image image, Double aDouble, Double aDouble1) {



		return new ThresholdingResult(new WritableImage(500,500), 0,0);
	}
